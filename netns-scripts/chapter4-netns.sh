...
#   router1: 192.168.1.1/24, 192.168.0.1/24, 192.168.3.1/24  (ip_forward=0)
#   router2: 192.168.0.2/24, 192.168.2.1/24  (ip_forward=1, gw: 192.168.0.1)
#   host2:   192.168.2.2/24  (gw: 192.168.2.1)
#   router3: 192.168.3.2/24, 192.168.4.1/24  (ip_forward=1, gw: 192.168.3.1)
#   host3:   192.168.4.2/24  (gw: 192.168.4.1)
#
